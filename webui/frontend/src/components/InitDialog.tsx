  ...
  return (
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        {mode === "cold" && (
          <div className="form-row"><label>fraction of liquid in the accumulator</label><input type="number" min={0} max={1} step={0.1} value={liq} onChange={(e) => setLiq(e.target.value)} /></div>
        )}
        {mode === "warm" && (
          <>
